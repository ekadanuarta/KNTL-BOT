...
*Model* : ${i.phone.device_model}\n\n`
	...
	case 'menu':
        ...
        txtt =`Hai ${pushname}\nPilih Opsi Dibawah Ini Ya.. `
               ...
               buttons = [{buttonId:`${prefix}koko`, 
               buttonText:{displayText: 'View Menu'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'Beban'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: 'Itsme Danuu', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*└─────────────────*
`
buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: 'Sampah'},type:1},{buttonId:`${prefix}ytadmin`,buttonText:{displayText:'Kepo'},type:1},{buttonId:`${prefix}donasi`,buttonText:{displayText:'Donasi Wee :('},type:1}]

               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Itsme Danuuu',
               buttons: buttons,
               headerType: 1
              }
